...
SharedElementArrayBuffer ElementArrayBuffer::create() { return std::make_shared<ElementArrayBuffer>(); }
...
void BoundElementArrayBuffer::setIndices(const std::vector<int8_t>& indices, GLenum usage) { setIndices(int(indices.size()), indices.data(), usage); }

void BoundElementArrayBuffer::setIndices(const std::vector<uint8_t>& indices, GLenum usage) { setIndices(int(indices.size()), indices.data(), usage); }

void BoundElementArrayBuffer::setIndices(const std::vector<int16_t>& indices, GLenum usage) { setIndices(int(indices.size()), indices.data(), usage); }

void BoundElementArrayBuffer::setIndices(const std::vector<uint16_t>& indices, GLenum usage) { setIndices(int(indices.size()), indices.data(), usage); }

void BoundElementArrayBuffer::setIndices(const std::vector<int32_t>& indices, GLenum usage) { setIndices(int(indices.size()), indices.data(), usage); }

void BoundElementArrayBuffer::setIndices(const std::vector<uint32_t>& indices, GLenum usage) { setIndices(int(indices.size()), indices.data(), usage); }

void BoundElementArrayBuffer::setIndices(int indexCount, const int8_t* data, GLenum usage) { setIndices(indexCount, GL_UNSIGNED_BYTE, data, usage); }

void BoundElementArrayBuffer::setIndices(int indexCount, const uint8_t* data, GLenum usage) { setIndices(indexCount, GL_UNSIGNED_BYTE, data, usage); }
...
void BoundElementArrayBuffer::setIndices(int indexCount, const int32_t* data, GLenum usage) { setIndices(indexCount, GL_UNSIGNED_INT, data, usage); }

void BoundElementArrayBuffer::setIndices(int indexCount, const uint32_t* data, GLenum usage) { setIndices(indexCount, GL_UNSIGNED_INT, data, usage); }
